...
FileWriter.prototype.write = function (filePath, encoding, lines, transformer, options) {
    ...
    var defaultLanguage = filePath.indexOf('Base.lproj');
    var valueToInsert = this.getTransformedLines(lines, transformer, defaultLanguage);
...
FileWriter.prototype.getTransformedLines = function (lines, transformer, defaultLanguage) {
    var valueToInsert = '';
