...
const flowTypeTransformer = {
    ...
    AUTOGENERATED_TAG: '//@flow script AUTO-GENERATED',
    insert: function (input, newValues, options) {
        newValues = newValues.substring(0, newValues.length - 1);
        const output = EOL +
            'export type TranslationTypes = ' + EOL +
            newValues + EOL
            + ';';
        return output;
    }
};
const LaravelTransformer = {
    transformComment: function (comment) {
        return "/*==== " + EOL + comment + EOL + " =======*/";
    },
    AUTOGENERATED_TAG: EOL + '/*======= AUTO-GENERATED translation tag lines -- zyntauri factory production =====*/' + EOL,
    ...
    transformKeyValue: function (key, value) {
       ...
       // normalizedValue = normalizedValue.replace(/([^\.]|^)(\.{3})([^\.]|$)/gi, '$1&#8230;$3');
        ...
        var ouput = '  \'' + key + '\'=>\'' + normalizedValue + '\',';
        return ouput;
    },

    insert: function (input, newValues) {
        var AUTOGENERATED_TAG = LaravelTransformer.AUTOGENERATED_TAG;
        ...
        var output = '';
        var closeTagIndex = input.indexOf('<?php');
        if (closeTagIndex < 0) {
            output = '<?php' + EOL + 'return [' + EOL ;
            // + '"sli"=>[';
        } else {
        ...
        output += AUTOGENERATED_TAG + EOL + newValues + EOL + '];';
        //+ '],];';
        return output;
    }
};
...
const iOSTransformer = {
    ...
    transformKeyValue: function (key, value) {
        ...
        //support ordered parameters %1%s -> %1$@
